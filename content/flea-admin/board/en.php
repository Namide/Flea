...
<table>
	<tbody>
		...
		<tr>
			...
			<td><?= (_URL_REWRITING) ? '<strong class="passed">true</strong>' : '<strong class="error">false</strong>'
?></td>
		</tr>
		<tr>
			<th>Debug mode</th>
			<td><?= (_DEBUG) ? '<strong class="error">true</strong>' : '<strong class="passed">false</strong>'
?></td>
		</tr>
		<tr>
			<th>Cache activated</th>
			<td><?= (_CACHE) ? '<strong class="passed">true</strong>' : '<strong class="error">false</strong>'
?></td>
		</tr>
		<tr>
			<th>SQL</th>
...
?>
		...
		<tr>
			...
			<td>
				...
				( $pagesCachedNum / _MAX_PAGE_CACHE > 0.95 ) ? 'error' : 'passed' ) . '">'
				, $pagesCachedNum . ' / ' . _MAX_PAGE_CACHE
				, '</strong>';
				?></td>
		</tr>
...
foreach ($pages as $id => $pageTemp) {
	...
	if ($pageTemp->getType() != \Flea\Page::$TYPE_REDIRECT301 &&
		...
		echo getLine($i, $url, $pageTemp->getName(), $pageTemp->getLang(), $errors, $linksString);
